...
public interface CmmRestApiService {
	...
	List<Map<String, Object>> getUserGroup(Map<String, Object> map, HttpSession session) throws Exception;
	...
	//request callback
	List<Map<String, Object>> requestService(Map<String, Object> map) throws Exception;
